...
TEST(MessageHandlerTests, ValidParseSignal)
{
...
TEST(CreatorMessageTests, CreateValidMessage)
{
	CreatorMessage creator({{"test", [](const std::string& t, Transaction tr, json::value& v) {
...
TEST(CreatorMessageTests, AddMessageOnMap)
{
...
TEST(CreatorMessageTests, CreateUnsupportedMessage)
{
	CreatorMessage creator;
	json::value jv;
	std::string type = "test";
