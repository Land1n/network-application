...
// 		client_socket.reset();
// 	}
// 	std::shared_ptr<ConnectionHandler> create_connection_handler(TypeConnectionHandler type, const AsyncCallBack& callback)
// 	{
// 		auto connection_handler = std::make_shared<ConnectionHandler>(*client_socket,type);
// 		if (type == TypeConnectionHandler::Async)
// 			connection_handler->setCallback(callback);
// 		connection_handler->connect(endpoint);
// 		client_context.run();
// 		return connection_handler;
// 	}
// 	std::shared_ptr<ConnectionHandler> create_connection_handler(TypeConnectionHandler type)
// 	{
...
// {
// 	auto con = create_connection_handler(TypeConnectionHandler::Sync);
// 	error_code error;
//
// 	TransportHandler transport_handler(*client_socket,TypeTransportHandler::Sync);
// 	transport_handler.write(create_test_message(),error);
//
// 	EXPECT_FALSE(error);
//
// }
...
// {
// 	TransportHandler transport_handler(*client_socket,TypeTransportHandler::Async);
//
// 	create_connection_handler(TypeConnectionHandler::Async,[&](error_code error) {
// 		transport_handler.write(create_test_message(),error);
// 		EXPECT_FALSE(error);
// 	});
// }
...
//
// 	TransportHandler transport_handler(*client_socket,TypeTransportHandler::Sync);
// 	transport_handler.write(for_write_message,error);
// 	EXPECT_FALSE(error);
//
// 	TransportHandler transport_handler_server(*server_socket,TypeTransportHandler::Sync);
// 	TransportMessage for_read_message;
//
// 	transport_handler_server.read(for_read_message,error);
// 	EXPECT_FALSE(error);
...
// 	});
// 	error_code error;
// 	TransportHandler transport_handler_server(*server_socket,TypeTransportHandler::Async);
// 	TransportMessage for_read_message;
//
// 	transport_handler_server.read(for_read_message,error);
// 	EXPECT_FALSE(error);
